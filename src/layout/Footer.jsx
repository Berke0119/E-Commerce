...
export default function Footer() {
  return (
    <footer className='bg-[#FAFAFA] pt-20 w-full'>
      ...
      <div className='flex flex-col gap-8 px-6 md:px-20 md:flex-row w-full justify-center items-start md:gap-40 py-20 bg-white'>
        <div>
